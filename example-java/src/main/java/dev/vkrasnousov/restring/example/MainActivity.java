...
public class MainActivity extends dev.vkrasnousov.restring.example.BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dev.vkrasnousov.restring.example.SampleStringsGenerator generator = new dev.vkrasnousov.restring.example.SampleStringsGenerator();
