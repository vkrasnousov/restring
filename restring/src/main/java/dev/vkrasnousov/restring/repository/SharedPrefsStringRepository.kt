...
import dev.vkrasnousov.restring.internal.repository.persistent.SharedPreferencesKeyValueStore
import dev.vkrasnousov.restring.internal.repository.persistent.SharedPrefsValueSetStore
import dev.vkrasnousov.restring.internal.repository.serializer.LocaleSerializer
import dev.vkrasnousov.restring.internal.repository.serializer.QuantityStringsSerializer
import dev.vkrasnousov.restring.internal.repository.serializer.StringArraysSerializer
import dev.vkrasnousov.restring.internal.repository.serializer.StringResourcesSerializer
...
class SharedPrefsStringRepository(
    ...
    private companion object {
        private const val LOCALES_SHARED_PREF_NAME = "dev.vkrasnousov.restring.Restring_Locals"
        private const val STRINGS_SHARED_PREF_NAME = "dev.vkrasnousov.restring.Restring_Strings"
        private const val QUANTITY_STRINGS_SHARED_PREF_NAME = "dev.vkrasnousov.restring.Restring_Quantity_Strings"
        private const val STRING_ARRAYS_SHARED_PREF_NAME = "dev.vkrasnousov.restring.Restring_String_Arrays"
    }
}